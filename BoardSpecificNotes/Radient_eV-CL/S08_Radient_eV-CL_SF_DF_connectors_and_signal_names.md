...
section: Radient_eV-CL_SF_DF_connectors_and_signal_names
module_tag: null
product: Aurora-Imaging-Library-board-specific-notes
version: 1100
path: "BoardSpecificNotes /  / radient_ev-cl / Radient eV-CL SF DF connectors and signal names"
---

# Zebra Radient eV-CL SF/DF connectors and signal names

This section serves as a reference to match Zebra Radient eV-CL SF and eV-CL DF's connectors and auxiliary signals with Aurora Imaging Library information, such as Aurora Imaging Library auxiliary/camera control signal numbers. To set/inquire all the settings for this board's auxiliary signals (for example, signal routing and timer settings), use [`MdigControl`](../../Reference/dig/MdigControl.md)/[`MdigInquire`](../../Reference/dig/MdigInquire.md), respectively.
...
| --- | --- |
| Zebra Radient eV-CL SF | [`M_DEV0`](../../Reference/dig/MdigAlloc.md). |
| Zebra Radient eV-CL DF | [`M_DEV0`](../../Reference/dig/MdigAlloc.md), [`M_DEV1`](../../Reference/dig/MdigAlloc.md). |
...
| Digitizer device # | Zebra Radient eV-CL SF | Zebra Radient eV-CL DF |
| --- | --- | --- |
| [`M_DEV0`](../../Reference/dig/MdigAlloc.md) | Auxiliary I/O connector A and C | Auxiliary I/O connector A and C |
...
The Zebra Radient eV-CL SF and eV-CL DF boards and cable adapter brackets provide several interface connectors. On the bracket of Zebra Radient eVCL SF, there are two Camera Link video input connectors and an auxiliary I/O connector. On the double bracket of Zebra Radient eV-CL DF, there are two pairs of Camera Link video input connectors and two auxiliary I/O connectors. On the cable adapter bracket, there are two external auxiliary I/O connectors.
