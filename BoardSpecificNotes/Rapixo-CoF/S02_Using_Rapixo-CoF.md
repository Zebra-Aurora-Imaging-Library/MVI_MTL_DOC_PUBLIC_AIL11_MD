...
For information on how to use the Processing FPGA of your Zebra Rapixo CoF100, see[Using Aurora Imaging Library for FPGA processing](../../UserGuide/C67_Using_AIL_with_FPGA_processing/ChapterInformation.md).
