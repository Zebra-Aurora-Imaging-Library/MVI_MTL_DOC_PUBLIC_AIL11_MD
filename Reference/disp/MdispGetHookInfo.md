...
doctype: Reference
module: disp
function: MdispGetHookInfo
product: Aurora-Imaging-Library-reference
preliminary: true
version: 1100
path: "Reference / disp / MdispGetHookInfo"
---
...
This function allows you to get information about the event that caused the hook-handler function to be called. [`MdispGetHookInfo`](../../Reference/disp/MdispGetHookInfo.md) should only be called within the scope of a display hook-handler function (see [`MdispHookFunction`](../../Reference/disp/MdispHookFunction.md)).

## Parameters

### `EventId` *(in, AIL_ID)*

Specifies the display event identifier received by the hook-handler function (see [`MdispHookFunction`](../../Reference/disp/MdispHookFunction.md)).
...
### For retrieving information about a general display hook event

Regardless of the display event that caused the hook-handler function to be called, the [`InfoType`](../../Reference/disp/MdispGetHookInfo.md) parameter can be set to the value below.

---

### `M_DISPLAY`

Retrieves the Aurora Imaging Library identifier of the display that generated the event.

| Value | Description |
| --- | --- |
| `Aurora Imaging Librarydisplay identifier` | Specifies the Aurora Imaging Library identifier of the display that generated the event. |

### For retrieving information regarding mouse events

If the hook-handler function was called due to an [`M_MOUSE_...`](../../Reference/disp/MdispHookFunction.md) event type, the [`InfoType`](../../Reference/disp/MdispGetHookInfo.md) parameter can be set to one of the values below.
...
| Value | Description |
| --- | --- |
| `Value` | Specifies the X-position of the cursor, in buffer coordinates. |
...
| Value | Description |
| --- | --- |
| `Value` | Specifies the Y-position of the cursor, in buffer coordinates. |
...
| Value | Description |
| --- | --- |
| `Value` | Specifies the X-position of the cursor, in display coordinates. |
...
| Value | Description |
| --- | --- |
| `Value` | Specifies the Y-position of the cursor, in display coordinates. |

---

### `M_MOUSE_WHEEL_VALUE`

Retrieves the value for the mouse wheel's rotation. Note, this value can only be retrieved if the hook-handler function was called due to the [`M_MOUSE_WHEEL`](../../Reference/disp/MdispHookFunction.md) event.
...
If the hook-handler function was called due to an [`M_KEY_...`](../../Reference/disp/MdispHookFunction.md) event type, the [`InfoType`](../../Reference/disp/MdispGetHookInfo.md) parameter can be set to the value below.

---

### `M_AIL_KEY_VALUE`

Retrieves the Aurora Imaging Library operating system-independent key code for the keyboard key that triggered the event. Note, this value can only be retrieved if the hook-handler function was called due to the[`M_KEY_DOWN`](../../Reference/disp/MdispHookFunction.md) or[`M_KEY_UP`](../../Reference/disp/MdispHookFunction.md) event.
...
If the hook-handler function was called due to either an [`M_KEY_...`](../../Reference/disp/MdispHookFunction.md) or [`M_MOUSE_...`](../../Reference/disp/MdispHookFunction.md) event type, the [`InfoType`](../../Reference/disp/MdispGetHookInfo.md) parameter can be set to the value below.
...
The returned value is `M_NULL` if successful. If the operation fails, a non-null (\![`M_NULL`](../../Reference/disp/MdispGetHookInfo.md)) value is returned.
