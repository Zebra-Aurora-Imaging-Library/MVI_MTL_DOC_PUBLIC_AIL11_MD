...
doctype: Reference
module: buf
function: MbufChild2d
product: Aurora-Imaging-Library-reference
version: 1100
path: "Reference / buf / MbufChild2d"
---
...
This function allocates a two-dimensional child buffer within a region of the specified, previously allocated data buffer. If the parent buffer is multi-band, this function allocates a multi-band child buffer; the child is allocated within the specified region in each band. To allocate a child region in one specific band, or specifically in all bands, use [`MbufChildColor2d`](../../Reference/buf/MbufChildColor2d.md) instead of [`MbufChild2d`](../../Reference/buf/MbufChild2d.md).
...
If allocation fails, [`M_NULL`](../../Reference/buf/MbufChild2d.md) is written as the identifier. |

## Return Value

**Type:** `AIL_ID`

The returned value is the child buffer identifier either as a standard identifier (_AIL_ID_) or a smart identifier (_AIL_UNIQUE_BUF_ID_). If allocation fails, `M_NULL` is returned (or _nullptr_ if[`M_UNIQUE_ID`](../../Reference/buf/MbufChild2d.md) was specified).
