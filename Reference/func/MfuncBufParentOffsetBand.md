...
doctype: Reference
module: func
function: MfuncBufParentOffsetBand
product: Aurora-Imaging-Library-reference
version: 1100
path: "Reference / func / MfuncBufParentOffsetBand"
---
...
> This function is equivalent to using [`MbufInquire`](../../Reference/buf/MbufInquire.md) with [`M_PARENT_OFFSET_BAND`](../../Reference/buf/MbufInquire.md), but provides no parameter checking or error reporting.
