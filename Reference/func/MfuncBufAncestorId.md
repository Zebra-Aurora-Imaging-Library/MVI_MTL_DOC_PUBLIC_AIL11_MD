...
doctype: Reference
module: func
function: MfuncBufAncestorId
product: Aurora-Imaging-Library-reference
version: 1100
path: "Reference / func / MfuncBufAncestorId"
---
...
Only child buffers have an ancestor buffer. The ancestor buffer is the buffer from which the specified buffer ([`BufferInfoHandle`](../../Reference/func/MfuncBufAncestorId.md)) ultimately originated. It is the root buffer; it does not have a parent buffer (it is not a child buffer of another buffer).
...
> This function is equivalent to using [`MbufInquire`](../../Reference/buf/MbufInquire.md) with [`M_ANCESTOR_ID`](../../Reference/buf/MbufInquire.md), but provides no parameter checking or error reporting.
